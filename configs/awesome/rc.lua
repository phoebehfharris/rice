...
screen.connect_signal("property::geometry", wp_change)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Left",   function () awful.tag.viewprev() writeTags() end,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey,           }, "Right",  function () awful.tag.viewnext() writeTags() end,
